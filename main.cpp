...
int main() {
    ...
    Stoc_magazin St1(1000, 500, 700, 1544, p1, c1, g1, cmd1, produse);
    ...
    std::cout << "Date stoc magazin: " << std::endl;
    Stoc_magazin St2(St1.getNrPixuriStoc(), St1.getNrGhiozdaneStoc(), St1.getNrCaieteStoc(), St1.sumaDupaVanzari(), p2,
                     c2, g2, cmd2, produse2);
    ...
    St2.cautaProdus("Pilot"); // de pus exceptie
    return 0;
}